...
>
  This report provides inward material details based on date and location. <br />
  (If no location is selected, inward data for all locations will be displayed.)
</Typography>
        <SelectLocation
          value={location}
