...
const MRApprovalLayout: React.FC<Props> = ({ children }) => {
  const navigate = useNavigate();
  const location = useLocation();
  const tabRoutes = [
    "/material-management/raw-material-approval",
    "/material-management/material-requisition-request",
  ];
...
export default MRApprovalLayout;
