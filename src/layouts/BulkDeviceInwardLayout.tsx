...
const BulkDeviceInwardLayout: React.FC<Props> = ({ children }) => {
  const navigate = useNavigate();
  const location = useLocation();
  const tabRoutes = ["/bulk-device-inward/create", "/bulk-device-inward/manage"];
...
export default BulkDeviceInwardLayout;
