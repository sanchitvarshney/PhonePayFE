...
const ProductionMaterialRequisitionLayout: React.FC<Props> = ({ children }) => {
  ...
  const tabRoutes = [
    "/production/material-req-with-bom",
    "/production/material-req-without-bom",
    "/production/swipe-device-request",
  ];
    ...
    <div className="h-full">
      <div className="w-full h-[50px] border-b border-neutral-300 bg-white">
        <Tabs
          ...
          value={currentTabIndex === -1 ? 1 : currentTabIndex}
        ...
        >
          ...
          <Tab
            ...
            label={
              <div className="flex items-center gap-[10px]">
                <Icons.warehouse fontSize="small" />
